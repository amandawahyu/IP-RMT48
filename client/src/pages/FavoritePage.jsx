...
export default function FavoritePage() {
    ...
    const uploadImageUser = async (e) => {
        ...
        try {
            ...
            console.log(data, "response upload");
            fetchDataUser();
        } catch (error) {
            console.log(error);
        }
    ...
    const fetchData = async () => {
        try {
            const { data } = await axios({
                method: "get",
                url: import.meta.env.VITE_API_URL + "/manhwasAndMangas/favorites",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                },
            });
    ...
    return (
        <>
            <div className="container my-5">
                <h4 className="text-center my-5">My Favorite Manhwa and Manga</h4>
